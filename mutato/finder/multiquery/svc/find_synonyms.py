...
class FindSynonyms(object):
    ...
    def __init__(self,
        ...
        Updated:
            1-Feb-2022
            craigtrim@gmail.com
            *   use base-block ontology name loader
                https://github.com/grafflr/graffl-core/issues/135
        ...
        self._find_canon = OwlFindCanon(
            d_synonyms_fwd=d_synonyms_fwd,
            d_synonyms_rev=d_synonyms_rev
        ).process
    ...
    def _has_synonyms_rev(self) -> bool:
        ...
        Returns:
            bool: True if synonyms exist
        """
        return self._d_synonyms_rev and len(self._d_synonyms_rev)
    ...
    def is_canon(self,
        ...
        return cleanse_canon(input_text) in self._d_synonyms_fwd
    ...
    def find_canon(self,
        ...
        """
        return self._find_canon(input_text)
